        ...
        <div className="p-6">
          <form className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 transition-all duration-300 hover:bg-gray-50 hover:border-green-500 hover:scale-105 hover:shad  ow-lg">
                {imageUrl ? (
